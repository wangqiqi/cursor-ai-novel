...
- **动作**：生成 `主题/_meta/第NN章_章前卡.md`。
- **核心**：确定本章「主运动」、节表、情绪曲线、**本章爽点（≥1）**、**章末钩子类型+钩子句**、对照 `主题/_meta/节奏窗.md` 标注是否开篇窗/高潮区。
...
- **动作**：生成 `主题/_meta/第NN章_第SS节_节前卡.md`。
...
- **🔴 铁律**：**所有检测报告、批注、元数据必须写入 `主题/_meta/`，严禁进入正文文件。**
- **备份**：原稿必须备份至 `.cursorGrowth/archive/`。

### 阶段 4：章后复盘 (Review)
- **动作**：全章完成后生成 `主题/_meta/第NN章_复盘.md`。
