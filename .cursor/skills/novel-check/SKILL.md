...
- [ ] **节奏窗**：若存在 `主题/_meta/节奏窗.md`，本章是否标注开篇窗/高潮区？开篇窗内是否已有设定+冲突+主角+兑现？（用项目登记章号，**禁止**用母版死章号判断）
- [ ] 主题推进到位？
...
- [ ] **本章回收**：哪些伏笔在 `主题/_meta/伏笔板.md` 中标记为回收？
- [ ] **本章埋设**：哪些新伏笔已登记？
- [ ] **凭空回收**：是否有"前文未埋"的回收？
- [ ] **超期未收**：是否有 > 10 章未回收的伏笔？
...
2. 读取章前卡（`主题/_meta/第NN章_章前卡.md`，如存在）
3. 扫描项目已有资产：
   - `主题/世界观.md`
